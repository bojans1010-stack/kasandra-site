...
const TRANSLATIONS = {
  en: {
    ...
    "how.intro": "Kasandra runs a single rules-based system on gold (XAU/USD). It reads the market around the clock and acts only when its conditions line up, with fixed risk on every trade — tight stops, single entries, no martingale, no revenge trading. You take its signals and trade them yourself. We never touch or hold your money. You trade through your own VT Markets account — your funds stay in your name, with the broker, under your control at all times. We simply provide the technology that connects you to the strategy.",
    ...
    "conn.nextp": "After you message us and we verify your VT account, we start your 3-day free trial. Once active, your members dashboard unlocks with the live signals and full results. You can log in any time to check your status.",
    ...
    "mem.reviewP": "Thanks for signing up. Complete the VT Markets steps below and message us on Telegram. Once we verify your account we start your 3 day free trial, and the live signals unlock here automatically.",
  ...
  mk: {
    ...
    "how.intro": "Kasandra работи со единствен систем базиран на правила за злато (XAU/USD). Го чита пазарот деноноќно и реагира само кога ќе се совпаднат неговите услови, со фиксен ризик на секое тргување — цврсти стопови, единечни влезови, без мартингал, без одмазднички тргувања. Ги земате неговите сигнали и тргувате сами. Ние никогаш не ги допираме или чуваме вашите пари. Тргувате преку вашата сопствена VT Markets сметка — вашите средства остануваат на ваше име, кај брокерот, под ваша контрола во секое време. Ние едноставно ја обезбедуваме технологијата што ве поврзува со стратегијата.",
  ...
  sr: {
    ...
    "how.intro": "Kasandra koristi jedinstven sistem zasnovan na pravilima za zlato (XAU/USD). Čita tržište 24 sata i reaguje samo kada se njegovi uslovi poklope, sa fiksnim rizikom na svakoj trgovini — čvrsti stopovi, jedan ulaz, bez martingala, bez osvetničkog trgovanja. Uzimate njegove signale i trgujete sami. Mi nikada ne diramo niti držimo vaš novac. Trgujete preko vašeg sopstvenog VT Markets naloga — vaša sredstva ostaju na vaše ime, kod brokera, pod vašom kontrolom u svakom trenutku. Mi jednostavno obezbeđujemo tehnologiju koja vas povezuje sa strategijom.",
